...
class AutoTasksScreen extends ConsumerWidget {
  ...
  static const Map<String, Map<String, dynamic>> _taskTypeConfig = {
    ...
    'role_count_exceeded': {
      'title': 'Rollenüberschreitungen',
      'icon': Icons.group,
      'color': Colors.indigo,
    },
    'birthday_gifts': {
      'title': 'Geschenke für Geburtstagskinder',
      'icon': Icons.cake,
      'color': Colors.pink,
    },
    'kitchen_team_gift': {
      'title': 'Geschenk für Küchenteam',
      'icon': Icons.restaurant,
      'color': Colors.green,
    },
    'familienfreizeit_non_member_check': {
      'title': 'Familienfreizeit-Prüfung',
      'icon': Icons.info,
            ...
            if (task.dueDate != null) ...[
              ...
              Row(
                children: [
                  ...
                  Text('Fällig: ${task.dueDate!.day}.${task.dueDate!.month}.${task.dueDate!.year}'),
                ],
              ),
            ],
            const SizedBox(height: AppConstants.spacing),
    ...
    if (task.taskType == 'outstanding_payment' || task.taskType == 'overdue_payment') {
      ...
      if (participant != null) {
        ...
        if (outstanding > 0.01) {
          ...
          AppLogger.info('Automatically created payment of ${outstanding.toStringAsFixed(2)}€ for participant ${participant.id}');
        }
      }
    }
  }
